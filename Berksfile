...
cookbook 'hadoop', :git => 'https://github.com/avaus/hadoop-cookbook.git'
cookbook 'hive', :git => 'https://github.com/avaus/hive-cookbook.git'
cookbook 'hue', :git => 'https://github.com/avaus/hue-cookbook.git'
